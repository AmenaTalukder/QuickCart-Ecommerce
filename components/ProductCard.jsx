...
const ProductCard = ({ product }) => {
  ...
  // Safely get the first image URL from nested arrays
  const validImage =
    product.image &&
    product.image.length > 0 &&
    Array.isArray(product.image[0]) &&
    product.image[0].length > 0 &&
    typeof product.image[0][0] === "string" &&
    product.image[0][0].trim() !== ""
      ? product.image[0][0]
      : "/placeholder.jpg";
  ...
  return (
    <div
      ...
      className="
        flex flex-col items-start gap-0.5 max-w-[200px] w-full cursor-pointer mb-10 px-4 py-2
